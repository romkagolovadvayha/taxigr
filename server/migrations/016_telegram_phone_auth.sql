CREATE TABLE IF NOT EXISTS telegram_auth_challenges (
  ...
  UNIQUE KEY uniq_telegram_auth_payload (payload_token),
  INDEX idx_telegram_auth_phone_created (expected_phone, created_at),
  INDEX idx_telegram_auth_user_pending (telegram_user_id, verified_at, expires_at),
  INDEX idx_telegram_auth_expiry (expires_at)
