...
// White mark outline from https://st.max.ru/brandbook/max-white.zip.
// Inline geometry paints with the button and needs no image request or decoding.
export function MaxLogo({ size = 26, color = '#FFFFFF' }: { size?: number; color?: string }) {
  return (
